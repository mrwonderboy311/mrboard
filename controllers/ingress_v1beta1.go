...
type IngressV1beta1Controller struct {
	beego.Controller
}

func (this *IngressV1beta1Controller) List() {
	...
	ingressList, err := m.IngListV1beta1(clusterId, nameSpace, ingressName, serviceName, labelsKey, labelsValue)
	msg := "success"
	code := 0
	count := len(ingressList)
	if err != nil {
...
func (this *IngressV1beta1Controller) Create() {
	clusterId := this.GetString("clusterId")
	msg := "success"
	code := 0
	err := m.IngCreateV1beta1(clusterId, this.Ctx.Input.RequestBody)
	if err != nil {
		log.Println(err)
		msg = err.Error()
		code = -1
...
func (this *IngressV1beta1Controller) CreateByYaml() {
	clusterId := this.GetString("clusterId")
	err := m.IngYamlCreateV1beta1(clusterId, this.Ctx.Input.RequestBody)
	msg := "success"
	code := 0
	if err != nil {
		log.Println(err)
...
func (this *IngressV1beta1Controller) ModifyByYaml() {
	clusterId := this.GetString("clusterId")
	nameSpace := this.GetString("nameSpace")
	ingressName := this.GetString("ingressName")

	//backup
	yamlStr, _ := m.GetIngYamlV1beta1(clusterId, nameSpace, ingressName)
	_ = m.InsertBackup(clusterId, nameSpace, ingressName, "ingress_beta1", yamlStr, "Backup before updating")

	reqBody := strings.ReplaceAll(string(this.Ctx.Input.RequestBody), "%25", "%")
	reqBody = strings.ReplaceAll(reqBody, "%3B", ";")

	err := m.IngYamlModifyV1beta1(clusterId, []byte(reqBody))
	if err != nil {
		log.Println(err)
	}
...
func (this *IngressV1beta1Controller) Detail() {
	clusterId := this.GetString("clusterId")
	nameSpace := this.GetString("nameSpace")
	ingressName := this.GetString("ingressName")
	xdetail, err := m.IngDetailV1beta1(clusterId, nameSpace, ingressName)
	if err != nil {
		log.Println(err)
	}
...
func (this *IngressV1beta1Controller) Del() {
	clusterId := this.GetString("clusterId")
	nameSpace := this.GetString("nameSpace")
	ingressName := this.GetString("ingressName")
	...
	err := m.IngDeleteV1beta1(clusterId, nameSpace, ingressName)
	if err != nil {
		log.Println(err)
	}
...
func (this *IngressV1beta1Controller) Yaml() {
	clusterId := this.GetString("clusterId")
	namespace := this.GetString("nameSpace")
	ingressName := this.GetString("ingressName")
...
func (this *IngressV1beta1Controller) GetRule() {
	clusterId := this.GetString("clusterId")
	nameSpace := this.GetString("nameSpace")
	ingressName := this.GetString("ingressName")
	xList, err := m.GetIngRuleV1beta1(clusterId, nameSpace, ingressName)
	code := 0
	msg := "success"
	if err != nil {
		log.Println(err)
...
func (this *IngressV1beta1Controller) UpdateRule() {
	clusterId := this.GetString("clusterId")
	nameSpace := this.GetString("nameSpace")
	ingressName := this.GetString("ingressName")
	//backup
	...
	err := m.UpdateIngRuleV1beta1(clusterId, nameSpace, ingressName, ingRuleArry)
	code := 0
	msg := "success"
	if err != nil {
...
func (this *IngressV1beta1Controller) GetTlsHost() {
	clusterId := this.GetString("clusterId")
	nameSpace := this.GetString("nameSpace")
	ingressName := this.GetString("ingressName")
	xList, err := m.GetIngTlsHostV1beta1(clusterId, nameSpace, ingressName)
	code := 0
	msg := "success"
	if err != nil {
		log.Println(err)
...
func (this *IngressV1beta1Controller) UpdateTlsHost() {
	clusterId := this.GetString("clusterId")
	nameSpace := this.GetString("nameSpace")
	ingressName := this.GetString("ingressName")
	//backup
	...
	err := m.UpdateIngTlsHostV1beta1(clusterId, nameSpace, ingressName, tlsHostArry)
	code := 0
	msg := "success"
	if err != nil {
