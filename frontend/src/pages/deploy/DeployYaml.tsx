...
export default function DeployYaml() {
  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center gap-4">
        ...
        <h1 className="text-2xl font-bold">YAML - {deployName}</h1>
      </div>
      <YamlViewer yaml={yaml} onUpdateUrl={'/mrboard/deploy/v1/ModifyByYaml?' + baseQuery} onUpdated={() => toast.success('更新成功')} />
    </div>
  )
}
