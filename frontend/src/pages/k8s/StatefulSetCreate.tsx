...
export default function StatefulSetCreate() {
  ...
  return (
    <div className="space-y-4 max-w-2xl">
      <h1 className="text-2xl font-bold">创建 StatefulSet</h1>
      <Card>
        <CardContent className="pt-6">
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-2">
              <label className="text-sm font-medium">StatefulSet 名称</label>
              <Input value={form.stsName} onChange={e => update('stsName', e.target.value)} required />
            </div>
            <div className="space-y-2">
