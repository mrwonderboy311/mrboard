...
func init() {
	...
	beego.Router("/mrboard/ai/v1/history/:id", &controllers.AIAnalysisController{}, "get:HistoryDetail;delete:DeleteHistory")
	beego.Router("/mrboard/ai/v1/history/clean", &controllers.AIAnalysisController{}, "post:CleanHistory")
